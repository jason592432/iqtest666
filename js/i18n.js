...
TRANSLATIONS['zh-CN'] = {
  ...
  'raven-spm.name': '瑞文标准推理测验 (SPM)',
  'raven-spm.desc': '真正的瑞文标准推理测验，60道全图形矩阵推理题',
  'raven-spm.meta': '60 题 · 40 分钟 · 6岁+',
  'reminder.back': '返回选择',
...
TRANSLATIONS['en'] = {
  ...
  'raven-spm.name': "Raven's SPM",
  'raven-spm.desc': "Standard Progressive Matrices - 60 pure figural matrix reasoning items",
  'raven-spm.meta': '60 items · 40 min · 6+',
  'reminder.back': 'Back',
