...
const TEST_WISC = {
  ...
  indexTitle: '韦氏四指数',
  indexConfig: {
    VCI: { label: '言语理解', short: 'VCI', color: '#11998e' },
    PRI: { label: '知觉推理', short: 'PRI', color: '#e74c8b' },
    WMI: { label: '工作记忆', short: 'WMI', color: '#f39c12' },
    PSI: { label: '加工速度', short: 'PSI', color: '#9b59b6' }
  },
  ...
  questions: [
    ...
    { id:1, type:'VCI', subtest:'类同', points:3, difficulty:'易',
      ...
      options:['都会游泳','都是宠物/动物','都能看家','都是白色'], correct:1,
      explanation:'猫和狗都是人们常见的宠物，也是动物' },
    { id:2, type:'VCI', subtest:'类同', points:3, difficulty:'易',
      question:'"铅笔" 和 "蜡笔" 的共同点是：',
      options:['都是红色','都可以写字画画','都是木头做的','都很长'], correct:1,
      explanation:'铅笔和蜡笔都是可以用来写字和画画的工具' },
    { id:3, type:'VCI', subtest:'类同', points:4, difficulty:'中',
      question:'"春天" 和 "秋天" 的共同点是：',
      options:['都很热','都是季节','都有落叶','白天都很长'], correct:1,
      explanation:'春天和秋天都是一年中的季节' },
    { id:4, type:'VCI', subtest:'词汇', points:3, difficulty:'易',
      question:'"勇敢" 最接近的意思是：',
      options:['害怕','胆小','不拍困难','生气'], correct:2,
      explanation:'勇敢就是不怕困难，敢于面对挑战' },
    { id:5, type:'VCI', subtest:'词汇', points:3, difficulty:'中',
      question:'"骄傲" 最接近的意思是：',
      options:['谦虚','自豪','难过','害怕'], correct:1,
      explanation:'骄傲指为自己取得的成绩感到自豪' },
    { id:6, type:'VCI', subtest:'词汇', points:3, difficulty:'中',
      question:'"奇妙" 最接近的意思是：',
      options:['普通','神奇','无聊','讨厌'], correct:1,
      explanation:'奇妙指非常神奇、令人惊奇的' },
    { id:7, type:'VCI', subtest:'常识', points:3, difficulty:'易',
      question:'一年有多少个月？',
      options:['10个月','11个月','12个月','13个月'], correct:2,
      explanation:'一年共有12个月' },
    { id:8, type:'VCI', subtest:'常识', points:3, difficulty:'易',
      question:'太阳从哪边升起？',
      options:['西方','南方','北方','东方'], correct:3,
      explanation:'太阳每天从东方升起' },
    { id:9, type:'VCI', subtest:'常识', points:3, difficulty:'中',
      question:'一周有几天？',
      options:['5天','6天','7天','8天'], correct:2,
      explanation:'一周共有7天' },
    { id:10, type:'VCI', subtest:'常识', points:3, difficulty:'中',
      question:'中国的首都是哪个城市？',
      options:['上海','广州','北京','深圳'], correct:2,
